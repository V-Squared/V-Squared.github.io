...
contents:
   ...
   - name: → Motivation by Design
     url: motivation
   - name: Developing / Evaluating
     url: developing
   - name: → Solving Problems
     url: solving-problems
   - name: → Multi Repo Management
     url: multi-repo
   - name: → Adding Scrum to GitHub
     url: adding-scrum
   - name: → Adding Dashboard 
     url: adding-dashboard
   - name: → Developing V²Plan
     url: developing-plan
   - name: → Adapting V²Plan
     url: adapting-plan
   - name: Reference
     url: reference
   - name: → Features of V²Plan
     url: features
   - name: → V²Plan Reference
     url: plan-reference
readiness:
   - is-complete
   - is-complete
...
Read → [more](/plan/agile/getting-started/agile-workflow/)
...
Read → [more](/plan/agile/getting-started/sprint-workflow/)
...
Read → [more](/plan/agile/getting-started/iterations/)


# Fundamentals {#fundamentals}

## Agile Development Primer {#agile-primer}
...
Read → [more](/plan/agile/fundamentals/agile-primer/)


## Motivation by Design {#motivation}
...
Read → [more](/plan/agile/fundamentals/motivation/)



# Developing / Evaluating {#developing}

## Solving today's Problems {#solving-problems}
...
Read → [more](/plan/agile/developing/solving-problems/)



## Multi Repository Management {#multi-repo}
...
Read → [more](/plan/agile/developing/multi-repo/)



## Adding Scrum to GitHub {#adding-scrum}
...
Read → [more](/plan/agile/developing/adding-scrum/)



## Adding Dashboard to GitHub {#adding-dashboard}
...
Read → [more](/plan/agile/developing/adapting/)



# Reference {#reference}

## Features of V²Plan {#features}
...
Read → [more](/plan/agile/reference/features/)



## V²Plan Reference {#plan-reference}
...
Read → [more](/plan/agile/reference/reference/)
