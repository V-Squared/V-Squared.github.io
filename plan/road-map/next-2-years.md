...
abstract: The development in the next two years is broken down into 10 campaigns. Each Campaign is described by its campaign target. The relationship between campaigns is expressed in their connections.
issueNo: 193
contents:
...
OEM are about shipping PCs in quantities. The *PC Consumer Market* is significantly larger than the workstation PC market. The introduction of V²Case Small opens the V² Modular PC to it. An important step to be attractive to OEM when we exhibit at Computex Taipei.
