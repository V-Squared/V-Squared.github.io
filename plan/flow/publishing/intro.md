...
We tried Joomla and Google Docs but found it to fell short of our requirements. We could not find such a system ready made. Instead we found many powerful open source building blocks that already did what we needed. V²Publishing is the open source glue to combine these wonderful building blocks into a homogeneous publishing system.
...
All software is FOSS (Free and Open Source). The server footprint is so small that many high quality zero cost hosting options are available. The navigation system can handle content ranging from a few pages to thousands. Contribution work can be tracked with the integrated workflow management. Anybody can contribute, just like Wikipedia, yet you have full control on accepting contribution.
...
It may be unique with its approach to make contribution to your website easy and available to anyone, just like to Wikipedia.
